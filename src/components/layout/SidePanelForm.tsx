...
export function SidePanelForm({
 ...
 <SheetContent side="right" className={`w-full ${maxWidthClass} p-0 flex flex-col h-full border-l bg-background shadow-sm overflow-y-auto`}>
 ...
 <Button type="button" variant="outline" className="flex-1 h-14 text-lg rounded-none font-medium tracking-tight" onClick={onCancel}>
 {cancelText}
 </Button>
 {onSubmit && (
 <Button type="submit" disabled={isSubmitting} className="flex-1 h-14 text-lg rounded-none shadow-sm flex items-center justify-center gap-2 font-medium tracking-tight bg-primary text-primary-foreground">
