...
export function CustomNumberInput({ isOpen, onClose, onConfirm, initialValue = 0 }: CustomNumberInputProps) {
 ...
 <div
 className="text-5xl md:text-6xl font-mono font-medium tracking-tighter text-primary truncate w-full text-center"
 >
 {displayValue}
 </div>
 </div>
 ...
 className="h-16 text-2xl font-medium rounded-none active:bg-accent hover:bg-accent/50 transition-colors flex items-center justify-center"
 >
 {k}
 </button>
 ))}
 ...
 className="w-full h-14 bg-primary text-primary-foreground font-medium tracking-tight rounded-none text-lg hover:opacity-90 active:scale-[0.98] "
 >
 Confirm
 </button>
 </div>
