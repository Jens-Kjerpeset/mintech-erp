...
const styles = StyleSheet.create({
 ...
 clientTitle: { fontSize: 10, color: '#888', marginBottom: 8 },
 ...
 colHeader: { fontSize: 10, fontWeight: 'bold', color: '#888' },
...
export function InvoicePDFViewer({ invoice }: { invoice: Invoice }) {
 ...
 return (
 <div className="w-full h-[600px] border rounded-none overflow-hidden bg-white">
